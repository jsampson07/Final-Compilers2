...
javac -d "$BUILD_DIR" -sourcepath "$IR_SRC_DIR":"$MIPS_SRC_DIR" "$IR_SRC_DIR"/*.java \
    "$IR_SRC_DIR"/ir/*.java "$IR_SRC_DIR"/ir/datatype/*.java "$IR_SRC_DIR"/ir/operand/*.java "$MIPS_SRC_DIR"/main/java/mips/*.java \
